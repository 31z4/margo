...
func GetKeysBadRequest(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.KeysController, key string) (http.ResponseWriter, error) {
	...
	getCtx, err := app.NewGetKeysContext(goaCtx, service)
	if err != nil {
...
// GetElementKeysBadRequest runs the method GetElement of the given controller with the given parameters.
// It returns the response writer so it's possible to inspect the response headers and the media type struct written to the response.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func GetElementKeysBadRequest(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.KeysController, key string, element string) (http.ResponseWriter, error) {
	...
	rw := httptest.NewRecorder()
	u := &url.URL{
		Path: fmt.Sprintf("/keys/%v/%v", key, element),
	}
	req, err := http.NewRequest("GET", u.String(), nil)
	if err != nil {
		panic("invalid test " + err.Error()) // bug
	...
	prms := url.Values{}
	prms["key"] = []string{fmt.Sprintf("%v", key)}
	prms["element"] = []string{fmt.Sprintf("%v", element)}
	if ctx == nil {
		ctx = context.Background()
	}
	goaCtx := goa.NewContext(goa.WithAction(ctx, "KeysTest"), rw, req, prms)
	getElementCtx, err := app.NewGetElementKeysContext(goaCtx, service)
	if err != nil {
		panic("invalid test data " + err.Error()) // bug
	}

	// Perform action
	err = ctrl.GetElement(getElementCtx)
...
// GetElementKeysNotFound runs the method GetElement of the given controller with the given parameters.
// It returns the response writer so it's possible to inspect the response headers and the media type struct written to the response.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
...
// GetElementKeysOK runs the method GetElement of the given controller with the given parameters.
// It returns the response writer so it's possible to inspect the response headers.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
...
func ListKeysOK(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.KeysController) http.ResponseWriter {
	...
	goaCtx := goa.NewContext(goa.WithAction(ctx, "KeysTest"), rw, req, prms)
	listCtx, err := app.NewListKeysContext(goaCtx, service)
	if err != nil {
		panic("invalid test data " + err.Error()) // bug
	}
...
// RemoveKeysOK runs the method Remove of the given controller with the given parameters.
// It returns the response writer so it's possible to inspect the response headers.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
...
// SetKeysBadRequest runs the method Set of the given controller with the given parameters and payload.
// It returns the response writer so it's possible to inspect the response headers and the media type struct written to the response.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func SetKeysBadRequest(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.KeysController, key string, payload app.SetKeysPayload) (http.ResponseWriter, error) {
	...
	goaCtx := goa.NewContext(goa.WithAction(ctx, "KeysTest"), rw, req, prms)
	setCtx, err := app.NewSetKeysContext(goaCtx, service)
	if err != nil {
		panic("invalid test data " + err.Error()) // bug
	}
	setCtx.Payload = payload
...
// SetKeysOK runs the method Set of the given controller with the given parameters and payload.
// It returns the response writer so it's possible to inspect the response headers.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
...
// UpdateKeysBadRequest runs the method Update of the given controller with the given parameters and payload.
// It returns the response writer so it's possible to inspect the response headers and the media type struct written to the response.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func UpdateKeysBadRequest(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.KeysController, key string, payload app.UpdateKeysPayload) (http.ResponseWriter, error) {
	...
	goaCtx := goa.NewContext(goa.WithAction(ctx, "KeysTest"), rw, req, prms)
	updateCtx, err := app.NewUpdateKeysContext(goaCtx, service)
	if err != nil {
		panic("invalid test data " + err.Error()) // bug
	}
